...
@csrf 
    ...
    <div class="form-group col-sm-4"> 
        ...
        <input type="hidden" name="no_jurnal" value="{{ $formatJurnal }}" class="form-control" id="exampleFormControlInput1" > 
                ...
                @foreach($detail as $temp) 
                    <tr> 
                        <td>
                            ...
                            <input name="kd_barang[]" class="form-control" type="hidden" value="{{$temp->kd_barang}}" readonly>{{$temp->kd_barang}}</td> <td>{{$temp->nm_barang}}
                        </td> 
                        <td>
                    ...
                    <tr> 
                        <td colspan="3"></td> 
                        <td>
                            <input name="total" class="form-control" type="hidden" value="{{$total}}">Total {{number_format($total)}}</a> 
                        <td ></td> 
                        </td> 
                    </tr> 
                </tbody> 
